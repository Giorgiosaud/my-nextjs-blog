/*
this project uses tailwind instead of bulma
*/
import './index.scss';
  ...
  return (
    <nav className="navbar">
      <div className="container">
        <a href="https://flowbite.com/" className="item">
            <img src="https://flowbite.com/docs/images/logo.svg" className="h-8 mr-3" alt="Flowbite Logo" />
            <span className="logo">Flowbite</span>
        </a>
        <button data-collapse-toggle="navbar-default" type="button" className="button" aria-controls="navbar-default" aria-expanded="false">
